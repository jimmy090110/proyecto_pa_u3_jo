...
public class EstudianteRepoImpl implements IEstudianteRepo {
	...
	public int eliminarPorApellido(String apellido) {
		// TODO Auto-generated method stub
		//DELETE FROM estudiante WHERE estu_apellido='Ortega'
		Query query= this.entityManager.createQuery("DELETE FROM Estudiante e WHERE e.apellido");
	...
	public int actualizarPorApellido(String apellido, String nombre) {
		...
		//UPDate estudiante set estu_nombre='Juan' WHERE estu_apellido='Ortega'
